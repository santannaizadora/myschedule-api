...
var validateLogin = function (email, password) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                user = _a.sent();
                isPasswordValid = user ? cryptr.decrypt(user.password) === password : false;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, userRepository.insert(data)];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
...
var login = function (email, password) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, validateLogin(email, password)];
            case 1:
                user = _a.sent();
                id = user.id, name = user.name;
                token = jwt.sign({ id: id, name: name }, process.env.JWT_SECRET);
